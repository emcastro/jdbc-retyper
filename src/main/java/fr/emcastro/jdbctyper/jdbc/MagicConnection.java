...
public class MagicConnection implements Connection {
    ...
    public MagicConnection(Connection connection, TypeTransformerRegistry registry) {
    ...
    public Statement createStatement() throws SQLException {
        return new MagicStatement(connection.createStatement(), registry, this);
    }

    @Override
    public Statement createStatement(int resultSetType, int resultSetConcurrency) throws SQLException {
        return new MagicStatement(connection.createStatement(resultSetType, resultSetConcurrency), registry, this);
    }
    ...
    public CallableStatement prepareCall(String sql) throws SQLException {
        return new MagicCallableStatement(connection.prepareCall(sql), registry, this);
    }
    ...
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        return new MagicPreparedStatement(connection.prepareStatement(sql), registry, this);
    }

    @Override
    public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
        return new MagicPreparedStatement(connection.prepareStatement(sql, autoGeneratedKeys), registry, this);
    }

    @Override
    public PreparedStatement prepareStatement(String sql, int[] columnIndexes) throws SQLException {
        return new MagicPreparedStatement(connection.prepareStatement(sql, columnIndexes), registry, this);
    }

    @Override
    public PreparedStatement prepareStatement(String sql, String[] columnNames) throws SQLException {
        return new MagicPreparedStatement(connection.prepareStatement(sql, columnNames), registry, this);
    }
