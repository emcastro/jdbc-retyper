...
public class MagicPreparedStatement extends MagicStatement implements PreparedStatement {
    ...
    public void setObject(int parameterIndex, Object x) throws SQLException {
        preparedStatement().setObject(parameterIndex, registry.toSql(x));
    }

    @Override
    public void setObject(int parameterIndex, Object x, int targetSqlType) throws SQLException {
        preparedStatement().setObject(parameterIndex, registry.toSql(x), targetSqlType);
    }

    @Override
    public void setObject(int parameterIndex, Object x, int targetSqlType, int scaleOrLength) throws SQLException {
        preparedStatement().setObject(parameterIndex, registry.toSql(x), targetSqlType, scaleOrLength);
    }
