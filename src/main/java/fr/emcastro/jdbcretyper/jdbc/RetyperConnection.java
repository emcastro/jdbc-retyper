...
public class RetyperConnection implements Connection {
    ...
    public RetyperConnection(Connection connection, TypeTransformerRegistry registry) {
    ...
    public Statement createStatement() throws SQLException {
        return new RetyperStatement(connection.createStatement(), registry, this);
    }

    @Override
    public Statement createStatement(int resultSetType, int resultSetConcurrency) throws SQLException {
        return new RetyperStatement(connection.createStatement(resultSetType, resultSetConcurrency), registry, this);
    }

    @Override
    public Statement createStatement(int resultSetType, int resultSetConcurrency, int resultSetHoldability)
            throws SQLException {
        return new RetyperStatement(
    ...
    public CallableStatement prepareCall(String sql) throws SQLException {
        return new RetyperCallableStatement(connection.prepareCall(sql), registry, this);
    }

    @Override
    public CallableStatement prepareCall(String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
        return new RetyperCallableStatement(
    ...
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        return new RetyperPreparedStatement(connection.prepareStatement(sql), registry, this);
    }

    @Override
    public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
        return new RetyperPreparedStatement(connection.prepareStatement(sql, autoGeneratedKeys), registry, this);
    }

    @Override
    public PreparedStatement prepareStatement(String sql, int[] columnIndexes) throws SQLException {
        return new RetyperPreparedStatement(connection.prepareStatement(sql, columnIndexes), registry, this);
    }

    @Override
    public PreparedStatement prepareStatement(String sql, String[] columnNames) throws SQLException {
        return new RetyperPreparedStatement(connection.prepareStatement(sql, columnNames), registry, this);
    }

    @Override
    public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency)
            throws SQLException {
        return new RetyperPreparedStatement(
