...
public class RetyperCallableStatement extends RetyperPreparedStatement implements CallableStatement {
    ...
    public Object getObject(int parameterIndex) throws SQLException {
        return registry.fromSqlDefaultType(callableStatement().getObject(parameterIndex));
    }

    @Override
    public Object getObject(String parameterName) throws SQLException {
        return registry.fromSqlDefaultType(callableStatement().getObject(parameterName));
    }

    @Override
    public Object getObject(int parameterIndex, Map<String, Class<?>> map) throws SQLException {
        return registry.fromSqlDefaultType(callableStatement().getObject(parameterIndex, registry.fromSqlMap(map)));
    }

    @Override
    public Object getObject(String parameterName, Map<String, Class<?>> map) throws SQLException {
        return registry.fromSqlDefaultType(callableStatement().getObject(parameterName, registry.fromSqlMap(map)));
    }
    ...
    public void setObject(String parameterName, Object x) throws SQLException {
        callableStatement().setObject(parameterName, registry.toSql(x));
    }

    @Override
    public void setObject(String parameterName, Object x, int targetSqlType) throws SQLException {
        callableStatement().setObject(parameterName, registry.toSql(x), targetSqlType);
    }
